...
ln -s /data/raw_data/computational_data/cancermuts_data/sno/EGFR/pancancer_clinvar/16112022/metatable_pancancer_EGFR.csv
...
# single domain
python get_mutlists.py -m metatable_pancancer_EGFR.csv -d 1:1072 -ch A -M -R
